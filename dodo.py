...
def task_pot():
    """Re-create .pot ."""
    return {
        "actions": ['python3 -m babel extract -F locales/babel-mapping.ini -o jackalify.pot jackalify'],
...
def task_po():
    """Update translations."""
    return {
        "actions": ['python3 -m babel update -D jackalify -d locales -i jackalify.pot'],
